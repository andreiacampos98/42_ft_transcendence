...
/*
const remoteTime = {{ stats.remote_time_played }};
const aiTime = {{ stats.ai_time_played }};
const localTime = {{ stats.local_time_played }};
const tournamentTime = {{ stats.tournament_time_played }};
*/

const remoteTime = 11;
const aiTime =38;
const localTime =21;
const tournamentTime =25;
// ApexCharts Donut Chart Configuration
var options = {
    chart: {
